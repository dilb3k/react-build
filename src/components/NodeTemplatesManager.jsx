...
function NodeTemplatesManager({ onBack, onLoadTemplate, onCreateNew }) {
                ...
                <div className="max-w-7xl mx-auto">
                    {templates.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-96 bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                            ...
                            <h2 className="text-2xl font-semibold mb-2 text-gray-800">No Templates</h2>
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        <span className="px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-50 text-blue-700">
                                                            {categoryOptions.find((c) => c.id === template.category)
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <div className="flex justify-end space-x-3">
                                                            <button
                                                                className="px-3 py-1.5 bg-blue-100 text-blue-700 border border-blue-300 rounded-md hover:bg-blue-100 transition-colors text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
...
export default NodeTemplatesManager;