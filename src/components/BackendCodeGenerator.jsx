            ...
            <div>
                ...
                {activeTab === "model" && (
                    <>
                        ...
                        <div className="mb-4">
                            ...
                            <div
                                className={`p-4 rounded-b-md rounded-r-md ${darkMode ? "bg-gray-700" : "bg-gray-50"
                                ...
                                <div className="mb-6">
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-1 ${darkMode ? "bg-gray-600 hover:bg-gray-500" : "bg-gray-200 hover:bg-gray-300"
                                                } text-sm rounded`}
                                        >
                                            + Add Field
                                        </button>
                                            ...
                                            <div key={index} className="grid grid-cols-12 gap-2 items-center">
                                                ...
                                                <div className="col-span-2 flex items-center">
                                                    <input
                                                        ...
                                                        className={`mr-2 h-4 w-4 ${darkMode ? "border-gray-500 bg-gray-600" : "border-gray-300"
                                                            } rounded ${darkMode ? "focus:ring-white" : "focus:ring-black"}`}
                                                    />
                        ...
                        <div className="flex justify-center">
                            <button
                                ...
                                className={`px-6 py-3 rounded-md font-medium ${darkMode ? "bg-blue-600 hover:bg-blue-700" : "bg-black hover:bg-gray-800"
                                    } text-white ${!mongoUrl ||
                                        models.some((model) => !model.name || model.fields.some((f) => !f.name))
                ...
                {activeTab === "code" && generatedCode && (
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded ${darkMode ? "bg-blue-600 hover:bg-blue-500" : "bg-black hover:bg-gray-800"
                        ...
                        <pre
                            className={`p-4 rounded-md overflow-auto max-h-96 text-sm border ${darkMode ? "bg-gray-900 border-gray-700" : "bg-gray-50 border-gray-200"
                                } font-mono`}
                        >
                            {generatedCode}
                        </pre>
